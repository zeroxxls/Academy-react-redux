...
let Shard = (() => {
    ...
    var Shard = _classThis = class extends _classSuper {
        ...
        async shardAndDistributeCollection(ns, key, unique, options) {
            ...
            const numInitialChunks = typeof unique === 'object'
                ? unique.numInitialChunks
                : options === null || options === void 0 ? void 0 : options.numInitialChunks;
            return await this.reshardCollection(ns, key, {
                numInitialChunks: numInitialChunks !== null && numInitialChunks !== void 0 ? numInitialChunks : 1000,
